...
int main() {
    ...
    // Global parameters
    float my_scale_factor = 5;          // Scale factor for time step
    float scaling = 5;                  // Scale factor for geometry
    ...
    for (int i = 0; i < num_template; i++) {
        // For this demo, using single sphere clumps
        int num_sphere = 1;
    ...
    // Sample positions in box region
